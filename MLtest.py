...
st.title("Linear Regression: Performance Rating vs. Monthly Income")

# Beispiel-Daten basierend auf der Tabelle
data = {
    "Performance": [3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 4, 3, 4, 3, 4, 3, 3, 3, 3, 4, 3, 3, 3, 3, 3, 3, 4, 4, 3, 3, 3, 3, 3, 3, 3, 3, 4],
...
ax.set_title("Linear Regression: Performance Rating vs. Monthly Income")
ax.legend()
